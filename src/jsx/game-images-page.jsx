...
class ImageItem extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="image-item" onClick={this.onClick}>
                <div className="image rectbox-image rectbox-covered">
...
export default class GameImagesPage extends React.Component {
    constructor(props) {
        super(props);

        this.store = DataStore.createItem("image-page-otype");
    ...
    render() {
        return (
            <div className="container">
                <div className="game-images-page">
                    <div className="top-bar">
                        <span className="title theme_secondary_text">{Language.getText(200104)}</span>
                    </div>

                    <GameTopicActionBar theme="otype"
                                    otype={this.state.otype}
                                    onChangeOType={this.handleChangeOType}/>
                    <div ref="topicList" className="image-list center-block theme_card_background">
                        {
                            this.state.topics.map((topic) => {
                                return <ImageItem key={"topic-" + topic.topic_id} topic={topic} />
                            })
                        }
                    </div>
                </div>
